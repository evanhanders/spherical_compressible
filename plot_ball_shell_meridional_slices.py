...
plotter.add_ball_shell_meridional_colormesh(ball_left='T1(phi=pi)', shell_left='B2_T1(phi=pi)', ball_right='T1(phi=0)', shell_right='B2_T1(phi=0)', remove_x_mean=True, **kwargs)
plotter.add_ball_shell_meridional_colormesh(ball_left='u(phi=pi)',  shell_left='B2_u(phi=pi)',  ball_right='u(phi=0)',  shell_right='B2_u(phi=0)', vector_ind=0, cmap='PuOr_r', **kwargs)
plotter.add_ball_shell_meridional_colormesh(ball_left='u(phi=pi)',  shell_left='B2_u(phi=pi)',  ball_right='u(phi=0)',  shell_right='B2_u(phi=0)', vector_ind=1, cmap='PuOr_r', **kwargs)
plotter.add_ball_shell_meridional_colormesh(ball_left='u(phi=pi)',  shell_left='B2_u(phi=pi)',  ball_right='u(phi=0)',  shell_right='B2_u(phi=0)', vector_ind=2, cmap='PuOr_r', **kwargs)

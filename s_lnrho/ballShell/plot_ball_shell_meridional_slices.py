...
plotter.add_ball_shell_meridional_colormesh(ball_left='B1_s1(phi=pi)', shell_left='B2_s1(phi=pi)', ball_right='B1_s1(phi=0)', shell_right='B2_s1(phi=0)', remove_x_mean=True, divide_x_mean=True, **kwargs)
plotter.add_ball_shell_meridional_colormesh(ball_left='B1_u(phi=pi)',  shell_left='B2_u(phi=pi)',  ball_right='B1_u(phi=0)',  shell_right='B2_u(phi=0)', vector_ind=0, cmap='PuOr_r', **kwargs)
plotter.add_ball_shell_meridional_colormesh(ball_left='B1_u(phi=pi)',  shell_left='B2_u(phi=pi)',  ball_right='B1_u(phi=0)',  shell_right='B2_u(phi=0)', vector_ind=1, cmap='PuOr_r', **kwargs)
plotter.add_ball_shell_meridional_colormesh(ball_left='B1_u(phi=pi)',  shell_left='B2_u(phi=pi)',  ball_right='B1_u(phi=0)',  shell_right='B2_u(phi=0)', vector_ind=2, cmap='PuOr_r', **kwargs)
